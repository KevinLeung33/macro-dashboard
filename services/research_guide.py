...
THEMES = {
    "美元流动性": {
        ...
        "signals": [
            ...
            ("yfinance", "DX-Y.NYB", "美元指数 DXY", "美元相对主要货币的强弱。上行常代表全球美元压力上升，但不是流动性的唯一指标。"),
    ...
    "增长与衰退": {
        ...
        "signals": [
            ...
            ("fred", "NAPM", "ISM制造业PMI", "制造业景气扩散指数。50 是扩张与收缩分界，方向通常比绝对点位更重要。"),
    ...
    "Crypto流动性": {
        ...
        "signals": [
            ...
            ("yfinance", "DX-Y.NYB", "美元指数 DXY", "美元走强常压制全球风险偏好，对 BTC 构成宏观逆风，但相关性会随阶段改变。"),
            ("fred", "DFII10", "10年期实际利率", "实际利率上行会提高无现金流资产的机会成本，是 BTC 的重要宏观背景变量。"),
            ("crypto", "BTC_ETF_NET_FLOW", "BTC ETF净流入", "受监管通道的净买卖需求代理。口径、发布日期和是否包含全部产品必须核对。"),
            ("crypto", "BTC_FUNDING_RATE", "BTC资金费率", "永续合约多空持仓成本。持续偏高提示多头拥挤，不等于价格会立即下跌。"),
        ],
