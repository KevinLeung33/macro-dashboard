...
def _plan_payload(note):
    fields = (
        "id", "venue", "symbol", "side", "order_id", "thesis", "setup", "entry_trigger",
        "stop_price", "target_price", "risk_note", "trade_type", "expected_horizon",
        "macro_horizon", "analysis_timeframe", "time_stop", "plan_status", "plan_expires_at",
